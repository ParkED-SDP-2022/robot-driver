...
//    Serial.println("EEPROM CHANGING!!!");
  }
  else
  {
  ...
  if(b<2)
  {
    ...
    if(i2cfreq==1)                                                             // thanks to Nick Gammon: http://gammon.com.au/i2c
    {
      TWBR=12;                                                                 // change to I²C clock of 400kHz
    }
    else
    {
      TWBR=72;                                                                 //  the I²C default clock is 100kHz
    } 
  }
  else
  {
