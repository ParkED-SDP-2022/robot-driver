...
namespace sensor_msgs
{
  ...
  class BatteryState : public ros::Msg
  {
    public:
      ...
      float * cell_voltage;
      uint8_t cell_temperature_length;
      float st_cell_temperature;
    ...
    virtual int serialize(unsigned char *outbuffer) const
    {
      ...
      *(outbuffer + offset++) = cell_temperature_length;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      *(outbuffer + offset++) = 0;
      for( uint8_t i = 0; i < cell_temperature_length; i++){
      union {
        float real;
        uint32_t base;
      } u_cell_temperaturei;
    ...
    virtual int deserialize(unsigned char *inbuffer)
    {
      ...
      uint8_t cell_temperature_lengthT = *(inbuffer + offset++);
